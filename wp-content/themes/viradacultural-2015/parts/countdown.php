<div id="countdown" class="col-md-2 hidden-sm hidden-xs">
    <div>Faltam</div>
    <input class="knob days" data-displayfield="days" data-field="hours" data-min="0" data-max="24" data-fgcolor="#e4c81e"/>
    <div>dias</div>
    <input class="knob hours" data-displayfield="hours" data-field="m" data-min="0" data-max="60" data-fgcolor="#e4c81e"/>
    <div>horas</div>
    <input class="knob minutes" data-displayfield="minutes" data-field="s" data-min="0" data-max="600" data-fgcolor="#e4c81e"/>
    <div>min</div>
    <footer>
        <time>
            <div>19|20</div>
