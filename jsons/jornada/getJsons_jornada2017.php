...
file_put_contents('/var/www/html/jsons/jornada/events.json', json_encode($result_events));
file_put_contents(__DIR__ . '/events.json', json_encode($result_events));
file_put_contents('/var/www/html/jsons/jornada/spaces.json', json_encode($spaces));
